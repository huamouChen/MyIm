package com.example.rexchen.myim.server;
...
import com.example.rexchen.myim.server.request.AddGroupMemberRequest;
import com.example.rexchen.myim.server.request.AddToBlackListRequest;
import com.example.rexchen.myim.server.request.AgreeFriendsRequest;
import com.example.rexchen.myim.server.request.ChangePasswordRequest;
import com.example.rexchen.myim.server.request.CheckPhoneRequest;
import com.example.rexchen.myim.server.request.CreateGroupRequest;
import com.example.rexchen.myim.server.request.DeleteFriendRequest;
import com.example.rexchen.myim.server.request.DeleteGroupMemberRequest;
import com.example.rexchen.myim.server.request.DismissGroupRequest;
import com.example.rexchen.myim.server.request.FriendInvitationRequest;
import com.example.rexchen.myim.server.request.JoinGroupRequest;
import com.example.rexchen.myim.server.request.LoginRequest;
import com.example.rexchen.myim.server.request.QuitGroupRequest;
import com.example.rexchen.myim.server.request.RegisterRequest;
import com.example.rexchen.myim.server.request.RemoveFromBlacklistRequest;
import com.example.rexchen.myim.server.request.RestPasswordRequest;
import com.example.rexchen.myim.server.request.SendCodeRequest;
import com.example.rexchen.myim.server.request.SetFriendDisplayNameRequest;
import com.example.rexchen.myim.server.request.SetGroupDisplayNameRequest;
import com.example.rexchen.myim.server.request.SetGroupNameRequest;
import com.example.rexchen.myim.server.request.SetGroupPortraitRequest;
import com.example.rexchen.myim.server.request.SetNameRequest;
import com.example.rexchen.myim.server.request.SetPortraitRequest;
import com.example.rexchen.myim.server.request.VerifyCodeRequest;
import com.example.rexchen.myim.server.response.AddGroupMemberResponse;
import com.example.rexchen.myim.server.response.AddToBlackListResponse;
import com.example.rexchen.myim.server.response.AgreeFriendsResponse;
import com.example.rexchen.myim.server.response.ChangePasswordResponse;
import com.example.rexchen.myim.server.response.CheckPhoneResponse;
import com.example.rexchen.myim.server.response.CreateGroupResponse;
import com.example.rexchen.myim.server.response.DefaultConversationResponse;
import com.example.rexchen.myim.server.response.DeleteFriendResponse;
import com.example.rexchen.myim.server.response.DeleteGroupMemberResponse;
import com.example.rexchen.myim.server.response.DismissGroupResponse;
import com.example.rexchen.myim.server.response.FriendInvitationResponse;
import com.example.rexchen.myim.server.response.GetBlackListResponse;
import com.example.rexchen.myim.server.response.GetFriendInfoByIDResponse;
import com.example.rexchen.myim.server.response.GetGroupInfoResponse;
import com.example.rexchen.myim.server.response.GetGroupMemberResponse;
import com.example.rexchen.myim.server.response.GetGroupResponse;
...
import com.example.rexchen.myim.server.response.GetUserInfoByPhoneResponse;
import com.example.rexchen.myim.server.response.GetUserInfosResponse;
import com.example.rexchen.myim.server.response.JoinGroupResponse;
import com.example.rexchen.myim.server.response.LoginResponse;
import com.example.rexchen.myim.server.response.QiNiuTokenResponse;
import com.example.rexchen.myim.server.response.QuitGroupResponse;
import com.example.rexchen.myim.server.response.RegisterResponse;
import com.example.rexchen.myim.server.response.RemoveFromBlackListResponse;
import com.example.rexchen.myim.server.response.RestPasswordResponse;
import com.example.rexchen.myim.server.response.SendCodeResponse;
import com.example.rexchen.myim.server.response.SetFriendDisplayNameResponse;
import com.example.rexchen.myim.server.response.SetGroupDisplayNameResponse;
import com.example.rexchen.myim.server.response.SetGroupNameResponse;
import com.example.rexchen.myim.server.response.SetGroupPortraitResponse;
import com.example.rexchen.myim.server.response.SetNameResponse;
import com.example.rexchen.myim.server.response.SetPortraitResponse;
import com.example.rexchen.myim.server.response.SyncTotalDataResponse;
import com.example.rexchen.myim.server.response.UserRelationshipResponse;
import com.example.rexchen.myim.server.response.VerifyCodeResponse;
import com.example.rexchen.myim.server.response.VersionResponse;
import com.example.rexchen.myim.server.utils.NLog;
import com.example.rexchen.myim.server.utils.json.JsonMananger;
