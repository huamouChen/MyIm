...
import com.example.rexchen.myim.server.widget.DialogWithYesOrNoUtils;
import com.example.rexchen.myim.ui.widget.switchbutton.SwitchButton;
...
public class AccountSettingActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initViews() {
        RelativeLayout mPassword = findViewById(R.id.ac_set_change_pswd);
        RelativeLayout mPrivacy = findViewById(R.id.ac_set_privacy);
        RelativeLayout mNewMessage = findViewById(R.id.ac_set_new_message);
        RelativeLayout mClean = findViewById(R.id.ac_set_clean);
        RelativeLayout mExit = findViewById(R.id.ac_set_exit);
        LinearLayout layout_push = findViewById(R.id.layout_push_setting);
        ...
        final SwitchButton mSwitchDetail =  findViewById(R.id.switch_push_detail);
